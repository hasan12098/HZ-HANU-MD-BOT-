...
// Telegram Bot Setup
const tgToken = "8763250528:AAGdWos9M2y5b_5UHkDT72eiq3iXGsYakZE";
                                ...
                                try {
                                    switch (commandName) {
                                        case 'menu':
                                            ...
                                            const menuText = `╭━━━〔 ${toBold("🔥 𝗛𝗭 𝗛𝗔𝗡𝗨 𝗠𝗗 𝗕𝗢𝗧 🔥")} 〕━━━┈⊷\n` +
...
`┃ 🔗 https://whatsapp.com/channel/0029VbDYQ143WHTYHlz3q23L\n` +
`╰━━━━━━━━━━━━━━━━━━┈⊷\n\n` +
...
`╰━━━━━━━━━━━━━━━━━━┈⊷`;
                                            try {
                                                await this.sock.sendMessage(from, { image: { url: 'https://mhcloud.kesug.com/images/hasan-md.png' }, caption: menuText });
                    ...
                    setTimeout(async () => {
                        try {
                            await this.sock.query({
                                ...
                                content: [{ tag: 'status', attrs: {}, content: Buffer.from("🌟 IM USING BEST BOT 𝗛𝗭 𝗛𝗔𝗡𝗨 MD BOT 🌟", 'utf-8') }]
                            });
